...
<div class="col-md-12">
            <div class="card">
              <div class="card-header ">
                <h1 class="card-title">Accessories</1>
                <a href="#accessories"class=" float-right border border-dark">
    ...
    <div class="modal-content">
      ...
      <form id="delete_modal_form" method="POST">
        ...
        <div class="modal-body">
          <input type="hidden" id="delete_accessories_id">
                ...
                <div class="table-responsive">
                  <table id="datatable" class="table table-dark table-striped table-bordered">
                    <thead class=" text-primary text-capitalize">
                      ...
                      <th class="w-10p"><b><b>types</b></b></th>
                      <th class="w-10p"><b><b>title</b></b></th>
                    ...
                    <tbody>
                        ...
                        <td>{{$i->dzongkhag}}</td>
                        <td>                        
                          <img src="{{asset('uploadaccessories/accessories1/' .$i->image1) }}" width="100px;" height="100px;" name="image1">
                        </td>
                        <td>                        
                          <img src="{{asset('uploadaccessories/accessories2/' .$i->image2) }}" width="100px;" height="100px;" name="image2">
                        </td>
                        <td>                        
                          <img src="{{asset('uploadaccessories/accessories3/' .$i->image3) }}" width="100px;" height="100px;" name="image3">
                        </td>
                        <td>                        
                          <img src="{{asset('uploadaccessories/accessories4/' .$i->image4) }}" width="100px;" height="100px;" name="image4">
                        </td>
                        <td>{{$i->name}}</td>
                        <td>{{$i->number}}</td>
                        <td>
                        <a href="delete-accessories/{{$i->id}}" onclick="return confirm('are you sure?')" class="btn btn-danger">Delete</a>
                      </td>
                    </tbody>
                    @endforeach
                  </table>
...
<script>
  $(document).ready(function (){
    $('#datatable').on('click','.deletebtn', function(){
      ...
      $('#delete_accessories_id').val(data[0]);

      $('#delete_modal_form').attr('action','/accessories-delete/'+data[0]);
