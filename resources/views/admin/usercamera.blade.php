...
<div class="col-md-12">
            <div class="card">
              <div class="card-header ">
                <h1 class="card-title">Camera</1>
                <a href="#camera"class=" float-right border border-dark">
                ...
                <div class="table-responsive">
                  <table id="datatable" class="table table-dark table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <td>{{$i->dzongkhag}}</td>
                        <td>                        
                          <img src="{{asset('uploadcameras/camera1/' .$i->image1) }}" width="100px;" height="100px;" name="image1">
                        </td>
                        <td>                        
                          <img src="{{asset('uploadcameras/camera2/' .$i->image2) }}" width="100px;" height="100px;" name="image2">
                        </td>
                        <td>                        
                          <img src="{{asset('uploadcameras/camera3/' .$i->image3) }}" width="100px;" height="100px;" name="image3">
                        </td>
                        <td>                        
                          <img src="{{asset('uploadcameras/camera4/' .$i->image4) }}" width="100px;" height="100px;" name="image4">
                        </td>
                        <td>{{$i->name}}</td>
                        <td>{{$i->number}}</td>
                        <td>
                        <a href="delete-camera/{{$i->id}}" onclick="return confirm('are you sure?')" class="btn btn-danger">Delete</a>
                      </td>
                    </tbody>
                    @endforeach
                  </table>
