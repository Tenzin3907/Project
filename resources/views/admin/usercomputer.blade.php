...
<div class="col-md-12">
            <div class="card">
              <div class="card-header ">
                <h1 class="card-title">computer</1>
    ...
    <div class="modal-content">
      ...
      <!-- <form id="delete_modal_form" method="POST">
        ...
        <div class="modal-body">
          <input type="hidden" id="delete_computer_id">
                ...
                <div class="table-responsive">
                  <table id="datatable" class="table table-dark table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <td>{{$i->dzongkhag}}</td>
                        <td>                        
                          <img src="{{asset('uploadcomputers/computer1/' .$i->image1) }}" width="100px;" height="100px;" name="image1">
                        </td>
                        <td>                        
                          <img src="{{asset('uploadcomputers/computer2/' .$i->image2) }}" width="100px;" height="100px;" name="image2">
                        </td>
                        <td>                        
                          <img src="{{asset('uploadcomputers/computer3/' .$i->image3) }}" width="100px;" height="100px;" name="image3">
                        </td>
                        <td>                        
                          <img src="{{asset('uploadcomputers/computer4/' .$i->image4) }}" width="100px;" height="100px;" name="image4">
                        </td>
                        <td>{{$i->name}}</td>
                        <td>{{$i->number}}</td>
                        <td>
                        <a href="delete-computer/{{$i->id}}" onclick="return confirm('are you sure?')" class="btn btn-danger">Delete</a>
                      </td>
                    </tbody>
                    @endforeach
                  </table>
...
<script>
  $(document).ready(function (){
    $('#datatable').on('click','.deletebtn', function(){
      ...
      $('#delete_modal_form').attr('action','/computer-delete/'+data[0]);
