...
<div class="small-container">
	...
	@endif
		<form action="{{url('save-book-data') }}"  class="form" method="POST"  enctype="multipart/form-data" onsubmit="return myfun()">
		{{csrf_field() }}
			<h2>
			...
			<div class="form-control">
				<h3>
					...
					<input type="text" placeholder="Book Title" name="title" id="price" required>
				</h3>
			</div>
			<div class="form-control"> 
				<h3>
