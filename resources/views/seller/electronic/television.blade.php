...
<div class="small-container">
	...
	@endif
		<!-- <form action="{{url('save-television') }}"  class="form" method="POST"  enctype="multipart/form-data"> -->
		<form action="{{url('save-television-data') }}"  class="form" method="POST"  enctype="multipart/form-data" onsubmit="return myfun()">
		{{csrf_field() }}
			<h2>
			...
			<div class="form-control">
				...
				<select id="com" name="brands">
					<option> </option>
					<option value="Panasonic">Panasonic</option>
					<option value="Sony">Sony</option>
					<option value="Lungta">Lungta</option>
