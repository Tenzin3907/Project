...
<div class="small-container">
	...
	@endif
		<form action="{{url('save-camera') }}"  class="form" method="POST"  enctype="multipart/form-data" onsubmit="return myfun()">
		{{csrf_field() }}
			<h2>
			...
			<div class="form-control">
				...
				<select id="cam" name="brands" style="width: 68%; height:45px;">
					<option> </option>
