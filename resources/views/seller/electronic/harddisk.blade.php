...
<div class="small-container">
	...
	@endif
		<!-- <form action="{{url('save-computer') }}"  class="form" method="POST"  enctype="multipart/form-data"> -->
		<form action="{{url('save-harddisk-data') }}"  class="form" method="POST"  enctype="multipart/form-data" onsubmit="return myfun()">
		{{csrf_field() }}
			<h2>
			...
			<ul>
				<li>
					<a><h1><i>Electronic and Appliances</i></h1></a>
				</li>
			</ul>
			</div>
			<hr>
			...
			<div class="form-control">
				<h3>
					...
					<input type="text" placeholder="Harddsik Title" name="title" id="price" required>
				</h3>
			</div>
			<div class="form-control">
				<h3>
