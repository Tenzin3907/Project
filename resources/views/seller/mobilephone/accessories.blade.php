...
<div class="small-container">
	...
	@endif
		<form action="{{url('save-accessories') }}"  class="form" method="POST"  enctype="multipart/form-data" onsubmit="return myfun()">
		{{csrf_field() }}
			<h2>
			...
			<ul>
				<li>
					<a><h1><i>Electronic Gadgets - Accessories</i></h1></a>
				</li>
			</ul>
			</div>
			<hr>
			...
			<div class="form-control">
				...
				<select name="type" id="type" style="width: 68%; height: 7vh; border:none;">
					<option value=" "> </option>
			...
			<div class="form-control">
				...
				<input type="text" placeholder="Mention the key features of your item (e.g. brand, model, age, type) " id="title" required>
			</div>
			<hr>
