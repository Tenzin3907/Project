...
<div class="small-container">
	...
	@endif
		<form action="{{url('save-tablet') }}"  class="form" method="POST"  enctype="multipart/form-data" onsubmit="return myfun()">
		{{csrf_field() }}
			<h2>
			...
			<ul>
				<li>
					<a><h1><i>Electronic Gadgets - Tablet</i></h1></a>
				</li>
			</ul>
			</div>
			<hr>
			...
			<div class="form-control">
				...
				<select id="com" name="type">
					<option> </option>
					<option value="Panasonic">iPads</option>
					<option value="Sony">Samsung</option>
					<option value="Lungta">Other Tablets</option>
				</select>
			</div>
