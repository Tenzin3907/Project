...
<div class="small-container">
	...
	@endif
		<form action="{{url('save-mobile') }}"  class="form" method="POST"  enctype="multipart/form-data" onsubmit="return myfun()">
		{{csrf_field() }}
			<h2>
			...
			<ul>
				<li>
					<a><h1><i>Electronic Gadgets - Mobile Phone</i></h1></a>
				</li>
			</ul>
			</div>
			<hr>
			...
			<div class="form-control" >
				...
				<select class="control1"  name="brand">
					<option></option>
