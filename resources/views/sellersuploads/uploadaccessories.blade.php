        ...
        @foreach($accessories as $data)
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
              <div class="portfolio-wrap">
                ...
                <img src="{{asset('uploadaccessories/accessories1/' .$data->image1) }}" class="img-fluid" alt="" width="100%;" height="90px;">
                </div>
                <div class="portfolio-info">
                  <div class="portfolio-links">
                    <a href="{{route('accessoriesdetails',$data->id)}}" title="More Details"><i class="bx bx-link"></i></a>
                  </div>
                </div>
                <br>
                <div style="background-color:white;">
                  <h6>Title : {{$data->brand}}</h6>
                  <!-- <h6>Accessories-id : {{$data->id}}</h6> -->
