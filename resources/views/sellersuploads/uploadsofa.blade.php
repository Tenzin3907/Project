        ...
        @foreach($sofa as $sofas)
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
              <div class="portfolio-wrap">
                ...
                <img src="{{asset('uploadsofa/sofa1/' .$sofas->image1) }}" class="img-fluid" alt="" width="100%;" height="90px;">
                </div>
                <div class="portfolio-info">
                  <div class="portfolio-links">
                    <a href="{{route('sofadetails',$sofas->id)}}" title="More Details"><i class="bx bx-link"></i></a>
                  </div>
                </div>
                <br>
                <div style="background-color:white;">
                  <h6>Product Brands : {{$sofas->brand}}</h6>
                  <!-- <h6> Sofa-id : {{$sofas->id}}</h6> -->
                  <p>Price: <strong>Nu. {{$sofas->price}}</strong></p>

                  <div style="height:25px; overflow: hidden;">
                              <p>Discription: {{$sofas->description}}</p>
                        </div>
                </div>
              </div>
            </div>
