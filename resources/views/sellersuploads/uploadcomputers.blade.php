        ...
        <div class="row portfolio-container" data-aos="fade-up">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
              <div class="portfolio-wrap">
                ...
                <img src="{{asset('uploadcomputers/computer1/' .$computer->image1) }}" class="img-fluid" alt="" width="100%;" height="90px;">
                </div>
                <div class="portfolio-info">
                  <div class="portfolio-links">
                    <a href="{{route('computerdetails',$computer->id)}}" title="More Details"><i class="bx bx-link"></i></a>
                  </div>
                </div>
                <br>
                <div style="background-color:white;">
                  <h6>Product Brands : {{$computer->brand}}</h6>
                  <!-- <h6>Stock : {{$computer->id}}</h6> -->
                  <p>Price: <strong> Nu. {{$computer->price}}</strong> </p>

                  <div style="height:25px; overflow: hidden;">
                              <p>Discription: {{$computer->description}}</p>
                        </div>
                </div>
              </div>
            </div>
