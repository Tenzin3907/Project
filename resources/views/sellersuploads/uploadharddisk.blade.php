        ...
        @foreach($harddisk as $data)
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
              <div class="portfolio-wrap">
                ...
                <img src="{{asset('uploadharddisk/harddisk1/' .$data->image1) }}" class="img-fluid" alt="" width="100%;" height="90px;">
                </div>
                <div class="portfolio-info">
                  <div class="portfolio-links">
                    <a href="{{route('harddiskdetails',$data->id)}}" title="More Details"><i class="bx bx-link"></i></a>
                  </div>
                </div>
                <br>
                <div style="background-color:white;">
                <h6>Name : {{$data->brand}}</h6>
                  <h6>Product Brands : {{$data->types}}</h6>
                  <!-- <h6>Harddisk-id : {{$data->id}}</h6> -->
