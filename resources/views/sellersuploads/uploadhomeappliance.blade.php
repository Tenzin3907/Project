...
<!-- static profile -->
 ...
 <section id="portfolio" class="portfolio section-bg">
      ...
      <div class="section-title" data-aos="fade-up">
        ...
        @foreach($homeappliance as $homeappliances)
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
              <div class="portfolio-wrap">
                <div class="height: 300px;">
                <img src="{{asset('uploadappliance/homeappliance1/' .$homeappliances->image1) }}" class="img-fluid" alt="" width="100%;" height="90px;">
                </div>
                <div class="portfolio-info">
                  <div class="portfolio-links">
                    <a href="{{route('homeappliancedetails',$homeappliances->id)}}" title="More Details"><i class="bx bx-link"></i></a>
                  </div>
                </div>
                <br>
                <div style="background-color:white;">
                  <h6>Title : {{$homeappliances->title}}</h6>
                  <!-- <h6>Homeappliance-id : {{$homeappliances->id}}</h6> -->
                  <p>Price: <strong>Nu. {{$homeappliances->price}}</strong></p>

                  <div style="height:25px; overflow: hidden;">
                              <p>Discription: {{$homeappliances->description}}</p>
                        </div>
                </div>
              </div>
            </div>
