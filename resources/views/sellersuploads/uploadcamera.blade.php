        ...
        @foreach($camera as $camera)
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
              <div class="portfolio-wrap">
                ...
                <img src="{{asset('uploadcameras/camera1/' .$camera->image1) }}" class="img-fluid" alt="" width="100%;" height="90px;">
                </div>
                <div class="portfolio-info">
                  <div class="portfolio-links">
                    <a href="{{route('cameradetails',$camera->id)}}" title="More Details"><i class="bx bx-link"></i></a>
                  </div>
                </div>
                <br>
                <div style="background-color:white;">
                  <h6>Product Brands : {{$camera->brand}}</h6>
                  <!-- <h6>Camera-id : {{$camera->id}}</h6> -->
                  <p>Price:<strong> Nu. {{$camera->price}}</strong></p>

                  <div style="height:25px; overflow: hidden;">
                              <p>Discription: {{$camera->description}}</p>
                        </div>
                </div>
              </div>
            </div>
