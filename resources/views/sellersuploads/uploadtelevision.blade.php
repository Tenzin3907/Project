...
<!-- static profile -->
 ...
 <section id="portfolio" class="portfolio section-bg">
      ...
      <div class="section-title" data-aos="fade-up">
        ...
        @foreach($television as $data)
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
              <div class="portfolio-wrap">
                <div class="height: 300px;">
                <img src="{{asset('uploadtelevision/television1/' .$data->image1) }}" class="img-fluid" alt="" width="100%;" height="90px;">
                </div>
                <div class="portfolio-info">
                  <div class="portfolio-links">
                    <a href="{{route('televisiondetails',$data->id)}}" title="More Details"><i class="bx bx-link"></i></a>
                  </div>
                </div>
                <br>
                <div style="background-color:white;">
                  <h6>Product Brands : {{$data->brand}}</h6>
                  <!-- <h6>Television-id : {{$data->id}}</h6> -->
                  <p>Price: <strong> Nu. </strong>{{$data->price}}</p>
